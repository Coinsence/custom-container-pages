<?php
/**
 * This file is a custom made php template for Coinsence platform
...
if (!$user) {
    $link_profile = $link_account = $link_search = '#';
} else {
...
<div class="landing">
    <div class="container">
        ...
        <div class="cards">
            ...
            <a class="card" href="<?= $link_campaigns ?>">
            ...
            <a class="card" href="<?= $link_marketplace ?>">
